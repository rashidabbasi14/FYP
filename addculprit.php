...
<body>
		...
		<div style='width:50%; margin:auto;'>
			<form action="PhpDB/addCulpritToDB.php" method="post" enctype="multipart/form-data">
			<?php
				echo "<div style='margin:0 auto;width: 200px;'><h1 style='color:black;'>Add Culprit</h></div><br><br>";
				$con=mysqli_connect('localhost','root','','rtfd');
				$sql="show columns from culprit";
