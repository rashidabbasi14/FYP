...
for($i=0;$i<sizeof($a);$i++)
{
	if(strlen($a[$i]) > 2)
		print"
			<a href='userPage.php?Culprit='$dir.$a[$i]'>
				<div class='media'>
					<img src='".$dir.$a[$i]."' height='100px' width='150px' style='margin-right:20px;border-radius: 50%;'>
					<div style='position:relative;'>
						<div class='price'><p style='display:inline;color:white;text-transform:capitalize;'>".str_replace(".jpg","",$a[$i])."</p><small>Culprit</small></div>
						<div class='stats'>
